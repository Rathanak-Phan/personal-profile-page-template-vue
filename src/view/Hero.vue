<template>
  <section class="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-blue-50 to-white px-4">
    <div class="max-w-2xl text-center">
      <h1 class="text-6xl md:text-7xl font-extrabold text-gray-900 mb-4 tracking-tight">
        Yourname
      </h1>
      ...
      <p class="text-lg md:text-xl text-gray-600 mb-10">
        I craft digital experiences that blend creativity with cutting-edge technology.<br>
